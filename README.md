...
```cmd
set Database_Host=jdbc:mysql://localhost:3306/taskflow
...
5. Add each variable:
   ...
   - Variable value: `jdbc:mysql://localhost:3306/taskflow`
...
```bash
export Database_Host="jdbc:mysql://localhost:3306/taskflow"
...
- `tasks` - Stores task information (id, title, description, status, priority, due_date, user_id)
...
- **Complete Setup Guide**: `COMPLETE_SETUP_GUIDE.md` - Step-by-step guide for backend AND frontend
- **Frontend Documentation**: `Frontend/README.md` - Next.js frontend specific guide
